...
public class T13DataIOStreamTest {
	public static void main(String[] args) throws IOException {
		...
		dos.writeFloat(3.14f);		// 실수형(f) 데이터 출력
		dos.writeDouble(3.14);		// 실수형(d) 데이터 출력
		...
		System.out.println("실수형(f) 데이터 : " +dis.readFloat());
		System.out.println("실수형(d) 데이터 : " +dis.readDouble());
